							...
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #a797ff; color: #000000; width: 680px; margin: 0 auto;" width="680">
										<tbody>
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 48px; padding-right: 48px; padding-top: 32px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 639.2px;"><img src="https://1bba98a539.imgdist.com/pub/bfra/o190qe3j/6ly/047/zuu/1d150f03-d30c-4309-be56-0e2bb7c7b617.png" style="display: block; height: auto; border: 0; width: 100%;" width="639.2" alt="An open email illustration" title="An open email illustration"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 16px;">Nos complace informarte que tu compañía ha sido exitosamente aprobada en nuestro sistema.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Después de una revisión completa, hemos confirmado que todos los documentos y detalles proporcionados cumplen con nuestros estándares. Nos complace confirmar que todo se encontraba en orden y que la documentación presentada era completa y precisa.</p>
																	<p style="margin: 0;">Esperamos que tengas una experiencia positiva en nuestro sistema.</p>
																</div>
															</td>
														</tr>
													</table>
													<table class="image_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 584px;"><img src="https://1bba98a539.imgdist.com/pub/bfra/o190qe3j/qnn/xtc/9l0/a4521dd5-9457-4b0b-a091-4ea4e3b70973.png" style="display: block; height: auto; border: 0; width: 100%;" width="584"></div>
																</div>
															</td>
														</tr>
													</table>
