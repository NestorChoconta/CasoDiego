														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 639.2px;"><img src="https://1bba98a539.imgdist.com/pub/bfra/o190qe3j/7b9/a9o/cws/codigo.png" style="display: block; height: auto; border: 0; width: 100%;" width="639.2" alt="An open email illustration" title="An open email illustration"></div>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-top:12px;text-align:center;width:100%;">
																<h1 style="margin: 0; color: #292929; direction: ltr; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 32px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 38.4px;"><strong>Nueva Compañía Registrada En Espera&nbsp;</strong></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-top:20px;">
																<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">A continuación, te proporcionamos el código de búsqueda para la compañía {{ $nameCompany }}:</p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="paragraph_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																<div style="color:#3e2d9c;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:34px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:40.8px;">
																	<p style="margin: 0;"><strong>{{ $verification_code }}</strong></p>
																</div>
															</td>
														</tr>
													</table>
