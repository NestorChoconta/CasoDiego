														...
														<tr>
															<td class="pad" style="padding-left:45px;padding-right:45px;padding-top:10px;">
																<div style="color:#393d47;font-family:'Cabin',Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:19px;line-height:150%;text-align:center;mso-line-height-alt:28.5px;">
																	<p style="margin: 0; word-break: break-word;">A continuación, te proporcionamos el código de busqueda para la compañia {{ $nameCompany }}:</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:45px;padding-right:45px;padding-top:10px;">
																<div style="color:#393d47;font-family:'Cabin',Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:36px;line-height:150%;text-align:center;mso-line-height-alt:54px;">
																	<p style="margin: 0; word-break: break-word;">{{ $verification_code }}</p>
																</div>
															</td>
														</tr>
													</table>
